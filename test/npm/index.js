...
lodash.mixin = mixin;
lodash.mockArray = require('lodash.mockarray');
lodash.mockFalse = require('lodash.mockfalse');
lodash.mockObject = require('lodash.mockobject');
lodash.mockTrue = require('lodash.mocktrue');
lodash.mockString = require('lodash.mockstring');
