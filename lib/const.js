...
exports.helpText = [
  ...
  '  --repo             GitHub repo to fetch lodash.js from (e.g. lodash/lodash',
  '                     or lodash/lodash#4.18.0 for a specific tag/branch/commit)',
  '  --source           Path to lodash.js source file to build from',
