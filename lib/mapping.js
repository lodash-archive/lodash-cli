...
module.exports = {
  ...
  'chainDep': createMap({
    'funcDep': ['arrayEach', 'arrayPush', 'baseForOwn', 'chain', 'createHybridWrapper', 'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'tap', 'thru', 'toInteger', 'wrapperAt', 'wrapperChain', 'wrapperCommit', 'wrapperNext', 'wrapperPlant', 'wrapperReverse', 'wrapperToIterator', 'wrapperValue'],
    'objDep': ['realNames'],
    'varDep': ['root']
  }),
  ...
  'forceInline': createMap({
    ...
    'getNative': ['isNative'],
    'keys': ['baseHas', 'baseKeys', 'indexKeys', 'isIndex', 'isPrototype'],
  ...
  'funcDep': createMap({
    ...
    'keys': ['baseHas', 'baseKeys', 'isArrayLike', 'indexKeys', 'isIndex', 'isPrototype'],
    'keysIn': ['baseKeysIn', 'indexKeys', 'isIndex', 'isPrototype'],
    'last': [],
