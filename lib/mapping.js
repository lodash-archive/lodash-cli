...
exports.funcDep = new Hash({
  ...
  'baseMean': ['baseSum'],
  'baseMerge': ['arrayEach', 'assignMergeValue', 'baseKeysIn', 'baseMergeDeep', 'isArray', 'isBuffer', 'isObject', 'isTypedArray', 'Stack'],
  'baseMergeDeep': ['assignMergeValue', 'cloneBuffer', 'cloneTypedArray', 'copyArray', 'initCloneObject', 'isArguments', 'isArray', 'isArrayLikeObject', 'isBuffer', 'isFunction', 'isObject', 'isPlainObject', 'isTypedArray', 'toPlainObject'],
  'baseNth': ['isIndex'],
