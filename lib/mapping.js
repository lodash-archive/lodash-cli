...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'difference': ['baseDifference', 'baseFlatten', 'isArrayLikeObject', 'restParam'],
    'differenceBy': ['baseDifferenceBy', 'baseFlatten', 'getIteratee', 'isArrayLikeObject', 'last', 'restParam'],
    ...
    'initial': ['dropRight'],
    'inRange': [],
    'intersection': ['arrayMap', 'baseIntersection', 'restParam', 'toArrayLikeObject'],
    'intersectionBy': ['arrayMap', 'baseIntersectionBy', 'getIteratee', 'last', 'restParam', 'toArrayLikeObject'],
    ...
    'unionBy': ['baseFlatten', 'baseUniqBy', 'getIteratee', 'last', 'restParam'],
    'uniq': ['baseUniq'],
    ...
    'without': ['baseDifference', 'isArrayLikeObject', 'restParam'],
    'words': ['toString'],
    'wrap': ['identity', 'partial'],
    'xor': ['arrayFilter', 'baseXor', 'isArrayLikeObject', 'restParam'],
    'xorBy': ['arrayFilter', 'baseXorBy', 'getIteratee', 'isArrayLikeObject', 'last', 'restParam'],
    'zip': ['restParam', 'unzip'],
    'zipObject': ['isArray'],
    ...
    'isArrayLikeObject': ['isArrayLike', 'isObject'],
    'isHostObject': [],
    'isIndex': [],
