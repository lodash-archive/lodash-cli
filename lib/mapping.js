...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'invokeMap': ['baseEach', 'baseInvoke', 'isKey', 'isArrayLike', 'rest'],
    ...
    'toLower': ['toString'],
    'toNumber': ['baseTrim', 'isFunction', 'isObject', 'isString'],
    ...
    'trim': ['baseTrim', 'toString', 'charsEndIndex', 'charsStartIndex', 'stringToArray'],
    ...
    'baseInvoke': ['isKey', 'last', 'parent', 'baseToPath'],
    ...
    'baseToPath': ['isArray', 'stringToPath'],
    'baseTrim': ['trimmedEndIndex', 'trimmedStartIndex'],
    'baseUnary': [],
