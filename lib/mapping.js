...
exports.funcDep = new Hash({
  ...
  'overArgs': ['apply', 'arrayMap', 'baseFlatten', 'baseUnary', 'getIteratee', 'isArray', 'rest'],
  ...
  'sortBy': ['baseFlatten', 'baseOrderBy', 'isArray', 'isIterateeCall', 'rest'],
  ...
  'createOver': ['apply', 'arrayMap', 'baseFlatten', 'baseUnary', 'getIteratee', 'isArray', 'rest'],
  ...
  'setToArray': [],
  'setToPairs': [],
  'setWrapToString': ['constant', 'getWrapDetails', 'identity', 'insertWrapDetails', 'updateWrapDetails'],
