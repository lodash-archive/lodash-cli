...
exports.funcDep = new Hash({
  ...
  'overArgs': ['apply', 'arrayMap', 'baseFlatten', 'getIteratee', 'isArray', 'isFlattenableIteratee', 'rest'],
  ...
  'baseNth': ['isIndex'],
  'baseOrderBy': ['arrayMap', 'baseMap', 'baseSortBy', 'compareMultiple', 'getIteratee', 'identity'],
  ...
  'createMathOperation': [],
  'createOver': ['apply', 'arrayMap', 'baseFlatten', 'getIteratee', 'isArray', 'isFlattenableIteratee', 'rest'],
