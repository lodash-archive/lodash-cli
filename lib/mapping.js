...
module.exports = {
  ...
  'forceInline': createMap({
    ...
    'toInteger': ['baseTrim', 'isFunction', 'isObject', 'isString', 'toNumber', 'trimmedEndIndex', 'trimmedStartIndex'],
    'toNumber': ['baseTrim', 'isFunction', 'isObject', 'isString', 'trimmedEndIndex', 'trimmedStartIndex'],
