...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'camelCase': ['createCompounder', 'stringToArray'],
    'capitalize': ['baseToString', 'stringToArray'],
    'ceil': ['createRound'],
    'chain': ['lodash'],
    ...
    'once': ['before'],
    'pad': ['baseToString', 'createPadding', 'stringSize', 'toInteger'],
    ...
    'setWith': ['baseSet'],
    'shuffle': ['sample'],
    'size': ['isArray', 'isArrayLike', 'isString', 'keys', 'stringSize'],
    ...
    'spread': [],
    'startCase': ['createCompounder', 'stringToArray'],
    ...
    'toArray': ['copyArray', 'isArray', 'isArrayLike', 'isMap', 'isSet', 'isString', 'iteratorToArray', 'mapToArray', 'setToArray', 'stringToArray', 'values'],
    'toInteger': [],
    ...
    'trunc': ['baseToString', 'isObject', 'isRegExp', 'stringSize', 'stringToArray', 'toInteger'],
    ...
    'baseAt': ['get'],
    'baseClone': ['copyArray', 'arrayEach', 'baseAssign', 'baseForOwn', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isHostObject', 'isMap', 'isObject', 'isSet'],
    'baseCreate': ['isObject'],
    'baseDelay': [],
    ...
    'baseIsEqualDeep': ['equalArrays', 'equalByTag', 'equalObjects', 'isArray', 'isHostObject', 'isMap', 'isSet', 'isTypedArray'],
    'baseIsFunction': [],
    ...
    'createModArgs': ['arrayEvery', 'baseFlatten', 'baseIsFunction', 'copyArray', 'restParam'],
  ...
  'hoist': createMap({
    'baseIteratee': ['baseGet', 'isArguments', 'isArray', 'keys', 'baseToPath'],
    'countBy': ['keys'],
