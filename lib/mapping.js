...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'toArray': ['copyArray', 'isArray', 'isArrayLike', 'isMap', 'isSet', 'isString', 'iteratorToArray', 'mapToArray', 'setToArray', 'values'],
    'toInteger': [],
    ...
    'trunc': ['baseToString', 'isObject', 'isRegExp', 'stringSize', 'toInteger'],
    ...
    'createPadding': ['repeat', 'stringSize', 'toInteger'],
