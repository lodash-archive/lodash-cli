...
module.exports = {
  ...
  'chainDep': createMap({
    'funcDep': ['arrayEach', 'arrayPush', 'baseForOwn', 'createHybridWrapper', 'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'thru'],
    'objDep': ['realNames']
  }),
  ...
  'funcDep': createMap({
    ...
    'identity': [],
    'includes': ['getIndexOf', 'isArray', 'isArrayLike', 'isString', 'values'],
    ...
    'sample': ['baseRandom', 'isArrayLike', 'toArray', 'values'],
    'set': ['baseSet'],
    'setWith': ['baseSet'],
    'shuffle': ['sample'],
    ...
    'trunc': ['baseToString', 'isObject', 'isRegExp'],
