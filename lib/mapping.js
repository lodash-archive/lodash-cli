...
exports.funcDep = new Hash({
  ...
  'isEmpty': ['getTag', 'isArguments', 'isArray', 'isArrayLike', 'isBuffer', 'isFunction', 'isObjectLike', 'isPrototype', 'isString', 'nativeKeys'],
  'isEqual': ['baseIsEqual'],
  ...
  'setWith': ['baseSet'],
  'shuffle': ['sampleSize'],
  'size': ['baseKeys', 'isArrayLike', 'isObjectLike', 'isString', 'getTag', 'stringSize'],
  ...
  'arrayIncludesWith': [],
  'arrayLikeKeys': ['baseTimes', 'isArguments', 'isArray', 'isIndex', 'isString'],
  'arrayMap': [],
  'arrayPush': [],
  'arrayReduce': [],
  'arrayReduceRight': [],
