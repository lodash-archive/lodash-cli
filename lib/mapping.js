...
exports.forceInline = new Hash({
  ...
  'baseIteratee': ['baseToString', 'keys', 'memoize', 'root', 'stringToPath'],
  'baseToString': ['root'],
  'createSet': ['root'],
  'createWrapper': ['root'],
  'stringToPath': ['baseToString', 'memoize', 'root']
});
...
exports.funcDep = new Hash({
  ...
  'isInteger': ['toInteger'],
  'isLength': [],
  'isMap': ['baseUnary', 'getTag', 'isObjectLike'],
  ...
  'isRegExp': ['baseUnary', 'isObject'],
  'isSafeInteger': ['isInteger'],
  'isSet': ['baseUnary', 'getTag', 'isObjectLike'],
  'isString': ['isArray', 'isObjectLike'],
  'isSymbol': ['isObjectLike'],
  'isTypedArray': ['baseUnary', 'isLength', 'isObjectLike'],
  'isUndefined': [],
  ...
  'last': [],
  'lastIndexOf': ['baseFindIndex', 'baseIsNaN', 'toInteger'],
  ...
  'baseHasIn': [],
  'baseIndexOf': ['baseFindIndex', 'baseIsNaN'],
  'baseIndexOfWith': [],
  'baseInRange': [],
  ...
  'baseIsNaN': [],
  'baseIsNative': ['isHostObject', 'isFunction', 'isMasked', 'isObject', 'toSource'],
