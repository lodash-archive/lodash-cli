...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'assignValue': [],
    'assignMergeValue': [],
    'assignSymbols': ['getSymbols'],
    'baseAssign': ['copyObject', 'keys'],
    'baseAt': ['get'],
    'baseClone': ['assignSymbols', 'assignValue', 'copyArray', 'arrayEach', 'baseAssign', 'baseForOwn', 'getTag', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isHostObject', 'isObject', 'Stack'],
    'baseConforms': ['keysIn'],
    'baseCreate': ['isObject'],
    'baseDelay': [],
