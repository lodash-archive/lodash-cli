...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'invokeMap': ['baseEach', 'baseInvokePath', 'isKey', 'isArrayLike', 'rest'],
    'invokePath': ['baseInvokePath', 'rest'],
    ...
    'method': ['baseInvokePath', 'rest'],
    'methodOf': ['baseInvokePath', 'rest'],
    ...
    'baseInvokePath': ['isKey', 'last', 'parent', 'baseToPath'],
