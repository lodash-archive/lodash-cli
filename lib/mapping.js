...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'baseAt': ['get'],
    'baseClone': ['assignSymbols', 'copyArray', 'arrayEach', 'baseAssign', 'baseForOwn', 'getTag', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isHostObject', 'isObject', 'Stack'],
    'baseConforms': ['keysIn'],
    'baseCreate': ['isObject'],
    'baseDelay': [],
