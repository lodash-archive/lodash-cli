...
module.exports = {
  ...
  'forceInline': createMap({
    ...
    'getNative': ['isNative'],
    'keys': ['baseHas', 'baseKeys', 'initKeys', 'isIndex', 'isPrototype'],
    'keysIn': ['baseKeysIn', 'initKeys', 'isIndex', 'isPrototype'],
    'template': ['attempt', 'isError'],
    'templateSettings': ['reEscape', 'reEvaluate'],
    'toInteger': ['charsLeftIndex', 'charsRightIndex', 'isString', 'stringToArray', 'toNumber', 'toString', 'trimmedLeftIndex', 'trimmedRightIndex'],
  ...
  'funcDep': createMap({
    ...
    'toLower': ['toString'],
    'toNumber': ['isFunction', 'isObject', 'isString', 'trim'],
    ...
    'baseCreate': ['isObject'],
    'baseDelay': [],
    'baseDifference': ['arrayMap', 'baseIncludes', 'baseUnary', 'cacheHas', 'includesWith', 'SetCache'],
    ...
    'baseHas': [],
    'baseHasIn': [],
    'baseIncludes': ['baseIndexOf'],
    'baseIndexOf': ['indexOfNaN'],
    'baseIntersection': ['arrayMap', 'baseIncludes', 'baseUnary', 'cacheHas', 'includesWith', 'SetCache'],
    ...
    'baseToPath': ['isArray', 'stringToPath'],
    'baseUnary': [],
    'baseUniq': ['baseIncludes', 'cacheHas', 'includesWith', 'SetCache'],
