...
module.exports = {
  ...
  'chainDep': createMap({
    'funcDep': [
      'arrayEach', 'arrayPush', 'baseForOwn', 'chain', 'createHybridWrapper',
      'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse',
      'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'tap', 'thru',
      'toInteger', 'wrapperAt', 'wrapperChain', 'wrapperCommit', 'wrapperFlatMap',
