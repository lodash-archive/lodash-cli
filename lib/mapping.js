...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'assign': ['copyObject', 'copyObjectWith', 'createAssigner', 'keys'],
    ...
    'defaults': ['extend', 'extendDefaults', 'restParam'],
    ...
    'extend': ['copyObject', 'copyObjectWith', 'createAssigner', 'keysIn'],
    ...
    'memoize': ['MapCache'],
    'merge': ['arrayEach', 'baseMergeDeep', 'createAssigner', 'isArray', 'isArrayLike', 'isObjectLike', 'isTypedArray', 'keysIn'],
    'min': ['identity', 'minBy'],
    ...
    'thru': [],
    'times': ['toFunction'],
    'toArray': ['copyArray', 'isArrayLike', 'isString', 'values'],
    ...
    'createAssigner': ['isIterateeCall', 'restParam', 'toObject'],
    'createBaseEach': ['isArrayLike', 'toObject'],
