...
exports.funcDep = new Hash({
  ...
  'createCurryWrapper': ['apply', 'createCtorWrapper', 'createHybridWrapper', 'createRecurryWrapper', 'lodash', 'replaceHolders'],
  'createFlow': ['baseFlatten', 'getData', 'getFuncName', 'isArray', 'isLaziable', 'LodashWrapper', 'rest'],
  'createHybridWrapper': ['composeArgs', 'composeArgsRight', 'countHolders', 'createCtorWrapper', 'createRecurryWrapper', 'lodash', 'reorder', 'replaceHolders'],
