...
exports.forceInline = new Hash({
  ...
  'baseIteratee': ['baseToString', 'keys', 'memoize', 'stringToPath'],
  'stringToPath': ['baseToString', 'memoize']
});
...
exports.funcDep = new Hash({
  ...
  'wrapperAt': ['baseAt', 'baseFlatten', 'baseRest', 'isIndex', 'LazyWrapper', 'LodashWrapper', 'thru'],
  'wrapperChain': ['chain'],
  ...
  'at': ['baseAt', 'baseFlatten', 'baseRest'],
  'attempt': ['apply', 'baseRest', 'isError'],
  'before': ['toInteger'],
  'bind': ['baseRest', 'createWrap', 'getHolder', 'replaceHolders'],
  'bindAll': ['arrayEach', 'baseFlatten', 'baseRest', 'bind', 'toKey'],
  ...
  'omit': ['arrayMap', 'baseDifference', 'baseFlatten', 'basePick', 'baseRest', 'getAllKeysIn', 'toKey'],
  'omitBy': ['basePickBy', 'getIteratee'],
  'once': ['before'],
  'orderBy': ['baseOrderBy', 'isArray'],
  'over': ['arrayMap', 'createOver'],
  'overArgs': ['apply', 'arrayMap', 'baseFlatten', 'baseRest', 'baseUnary', 'getIteratee', 'isArray'],
  ...
  'pick': ['arrayMap', 'baseFlatten', 'basePick', 'baseRest', 'toKey'],
  ...
  'pullAt': ['arrayMap', 'baseAt', 'baseFlatten', 'basePullAt', 'compareAscending', 'isIndex', 'baseRest'],
  'random': ['baseRandom', 'isIterateeCall', 'toNumber'],
  'range': ['createRange'],
  'rangeRight': ['createRange'],
  'rearg': ['baseFlatten', 'baseRest', 'createWrap'],
  ...
  'createFlow': ['baseFlatten', 'baseRest', 'getData', 'getFuncName', 'isArray', 'isLaziable', 'LodashWrapper'],
  ...
  'createOver': ['apply', 'arrayMap', 'baseFlatten', 'baseRest', 'baseUnary', 'getIteratee', 'isArray'],
...
exports.seqDep = new Hash({
  'funcDep': [
    ...
    'lazyReverse', 'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'tap',
    'thru', 'toInteger', 'wrapperAt', 'wrapperChain', 'wrapperCommit', 'wrapperNext',
