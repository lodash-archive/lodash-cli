...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'has': ['baseGet', 'baseSlice', 'isArray', 'isIndex', 'isKey', 'isString', 'last', 'toPath'],
    'identity': [],
    ...
    'baseMerge': ['arrayEach', 'baseMergeDeep', 'getSymbols', 'isArray', 'isLength', 'isObject', 'isObjectLike', 'isTypedArray', 'keys'],
