...
module.exports = {
  ...
  'chainDep': createMap({
    'funcDep': ['arrayEach', 'arrayPush', 'baseForOwn', 'chain', 'createHybridWrapper', 'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'tap', 'thru', 'toInteger', 'wrapperChain', 'wrapperCommit', 'wrapperConcat', 'wrapperPlant', 'wrapperReverse', 'wrapperToString', 'wrapperValue'],
    'objDep': ['realNames']
  }),
  ...
  'forceInline': createMap({
    'baseEach': ['baseFor'],
    'baseIteratee': ['baseGet', 'baseIsMatch', 'baseMatches', 'baseMatchesProperty', 'baseSlice', 'baseToString', 'getNative', 'isFunction', 'isNative', 'toPath'],
    'getNative': ['isFunction', 'isNative'],
    'keys': ['initKeys', 'isArguments', 'isString'],
    'keysIn': ['baseKeysIn', 'initKeys', 'isArguments', 'isString'],
  ...
  'funcDep': createMap({
    ...
    'every': ['arrayEvery', 'baseEvery', 'getIteratee', 'isArray'],
    ...
    'indexOf': ['baseIndexOf', 'binaryIndex', 'toInteger'],
    'initial': ['dropRight'],
    'inRange': [],
    ...
    'last': [],
    'lastIndexOf': ['indexOfNaN', 'binaryIndex', 'toInteger'],
    ...
    'some': ['arraySome', 'baseSome', 'getIteratee', 'isArray'],
    ...
    'sum': ['identity', 'arraySum'],
    'sumBy': ['arraySum', 'getIteratee'],
    'take': ['baseSlice'],
    ...
    'uniqBy': ['baseIteratee', 'baseUniq', 'getIteratee', 'getIndexOf', 'sortedUniq'],
    'uniqueId': ['baseToString'],
    'unzip': ['arrayMap', 'arrayFilter', 'baseProperty', 'isArrayLike', 'isObject'],
    ...
    'baseMerge': ['arrayEach', 'assignMergeValue', 'baseMergeDeep', 'isArray', 'isObjectLike', 'isTypedArray', 'keysIn'],
    'baseMergeDeep': ['assignMergeValue', 'copyArray', 'isArguments', 'isArray', 'isArrayLike', 'isObject', 'isPlainObject', 'isTypedArray', 'toPlainObject'],
    'basePick': [],
    'basePickBy': ['baseForIn'],
    'baseProperty': [],
    'basePropertyDeep': ['baseGet'],
    'basePullAt': ['baseGet', 'baseSlice', 'isIndex', 'isKey', 'last', 'toPath'],
    'baseRandom': [],
    'baseReduce': [],
    ...
    'initCloneObject': [],
    'initKeys': ['isArguments', 'isArray', 'isLength', 'isString'],
