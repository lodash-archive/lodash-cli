...
module.exports = {
  ...
  'forceInline': createMap({
    'baseEach': ['baseFor'],
    'baseCallback': ['baseIsMatch', 'baseMatches', 'baseMatchesProperty', 'baseProperty'],
  ...
  'funcDep': createMap({
    ...
    'get': ['baseGet', 'isKey', 'toObject', 'toPath'],
    'groupBy': ['createAggregator'],
    'has': ['baseGet', 'baseSlice', 'isKey', 'last', 'toPath'],
    'identity': [],
    ...
    'propertyOf': ['baseGet', 'constant', 'isKey', 'toObject', 'toPath'],
    'pull': ['getIndexOf'],
    ...
    'baseMatchesProperty': ['baseGet', 'baseIsEqual', 'baseSlice', 'isKey', 'isStrictComparable', 'toObject', 'toPath'],
    ...
    'baseProperty': [],
    'basePropertyDeep': ['baseGet', 'toObject', 'toPath'],
    'basePullAt': ['isIndex'],
    'baseRandom': [],
    'baseReduce': [],
