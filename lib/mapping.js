...
exports.funcDep = new Hash({
  ...
  'castArray': ['isArray'],
  'castFunction': ['identity', 'isFunction'],
  ...
  'forEach': ['arrayEach', 'baseEach', 'castFunction', 'isArray'],
  'forEachRight': ['arrayEachRight', 'baseEachRight', 'castFunction', 'isArray'],
  'forIn': ['baseFor', 'castFunction', 'keysIn'],
  'forInRight': ['baseForRight', 'castFunction', 'keysIn'],
  'forOwn': ['baseForOwn', 'castFunction'],
  'forOwnRight': ['baseForOwnRight', 'castFunction'],
  'fromPairs': [],
  ...
  'result': ['castPath', 'get', 'isFunction', 'isKey', 'parent'],
  'reverse': [],
  'round': ['createRound'],
  ...
  'thru': [],
  'times': ['baseTimes', 'castFunction', 'toInteger'],
  ...
  'getTag': [],
  'getView': [],
  'hasPath': ['castPath', 'isArguments', 'isArray', 'isIndex', 'isKey', 'isLength', 'isString', 'last', 'parent'],
  'indexOfNaN': [],
  'initCloneArray': [],
