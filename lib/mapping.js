...
exports.funcDep = new Hash({
  ...
  'tap': [],
  'template': ['arrayEach', 'customDefaultsAssignIn', 'assignWith', 'attempt', 'baseValues', 'escapeStringChar', 'isError', 'isIterateeCall', 'keys', 'toString'],
