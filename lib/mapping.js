...
exports.forceInline = new Hash({
  'baseClone': ['baseFor','keys', 'MapCache', 'root', 'Stack'],
...
exports.funcDep = new Hash({
  ...
  'isEmpty': ['isArguments', 'isArray', 'isArrayLike', 'isFunction', 'isString'],
  'isEqual': ['baseIsEqual'],
  ...
  'result': ['baseCastPath', 'baseGet', 'isFunction', 'isKey', 'parent'],
  'reverse': [],
  'round': ['createRound'],
  ...
  'baseClamp': [],
  'baseClone': ['assignValue', 'cloneBuffer', 'copyArray', 'copySymbols', 'arrayEach', 'baseAssign', 'baseForOwn', 'getTag', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isBuffer', 'isHostObject', 'isObject', 'Stack'],
  'baseConforms': ['keys'],
  'baseCreate': ['isObject'],
  'baseDelay': [],
  ...
  'extremumBy': ['baseEach'],
  'getAllKeysIn': ['arrayPush', 'getSymbolsIn', 'isArray', 'keysIn'],
  'getData': ['noop'],
  'getFuncName': [],
