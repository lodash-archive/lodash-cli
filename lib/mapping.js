...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'trim': ['baseToString', 'charsLeftIndex', 'charsRightIndex', 'stringToArray', 'trimmedLeftIndex', 'trimmedRightIndex'],
    'trimLeft': ['baseToString', 'charsLeftIndex', 'stringToArray', 'trimmedLeftIndex'],
    'trimRight': ['baseToString', 'charsRightIndex', 'stringToArray', 'trimmedRightIndex'],
