...
exports.funcDep = new Hash({
  ...
  'defaults': ['apply', 'customDefaultsAssignIn', 'assignInWith', 'baseRest'],
  ...
  'baseIsEqualDeep': ['copyObject', 'equalArrays', 'equalByTag', 'equalObjects', 'getTag', 'isArray', 'isBuffer', 'isTypedArray', 'keys', 'Stack'],
