...
exports.funcDep = new Hash({
  ...
  'bindAll': ['arrayEach', 'baseAssignValue', 'baseFlatten', 'baseRest', 'bind', 'toKey'],
  ...
  'baseAt': ['get'],
  'baseClamp': [],
  'baseClone': ['arrayEach', 'baseAssign', 'baseAssignValue', 'cloneBuffer', 'copyArray', 'copySymbols', 'getAllKeys', 'getTag', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isBuffer', 'isObject', 'keys', 'Stack'],
