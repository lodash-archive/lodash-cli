...
exports.funcDep = new Hash({
  ...
  'arraySampleSize': ['copyArray', 'shuffleSelf'],
  ...
  'baseMergeDeep': ['assignMergeValue', 'cloneTypedArray', 'copyArray', 'initCloneObject', 'isArguments', 'isArray', 'isArrayLikeObject', 'isFunction', 'isObject', 'isPlainObject', 'isTypedArray', 'toPlainObject'],
  'baseNth': ['isIndex'],
  ...
  'baseSampleSize': ['shuffleSelf', 'values'],
