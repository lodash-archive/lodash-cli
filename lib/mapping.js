...
exports.funcDep = new Hash({
  ...
  'before': ['toInteger'],
  'bind': ['createWrap', 'getHolder', 'rest', 'replaceHolders'],
  'bindAll': ['arrayEach', 'baseFlatten', 'bind', 'rest', 'toKey'],
  'bindKey': [ 'createWrap', 'getHolder', 'rest', 'replaceHolders'],
  ...
  'parseInt': ['toString'],
  'partial': ['createWrap', 'getHolder', 'rest', 'replaceHolders'],
  'partialRight': ['createWrap', 'getHolder', 'rest', 'replaceHolders'],
  ...
  'rearg': ['baseFlatten', 'createWrap', 'rest'],
  ...
  'createRecurry': ['isLaziable', 'setData'],
  ...
  'createWrap': ['baseSetData', 'createBind', 'createCurry', 'createHybrid', 'createPartial', 'getData', 'mergeData', 'setData', 'toInteger'],
...
exports.seqDep = new Hash({
  'funcDep': [
    'arrayEach', 'arrayPush', 'baseForOwn', 'baseInvoke', 'chain', 'createHybrid',
    'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse',
    'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'rest', 'tap', 'thru',
    'toInteger', 'wrapperAt', 'wrapperChain', 'wrapperCommit', 'wrapperNext',
    'wrapperPlant', 'wrapperReverse', 'wrapperToIterator', 'wrapperValue'
  ],
  'objDep': ['realNames'],
  'varDep': []
});
