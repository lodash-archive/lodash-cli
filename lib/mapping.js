...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'defaults': ['assign', 'assignDefaults', 'createDefaults'],
    ...
    'max': ['createExtremum', 'maxBy'],
    'maxBy': ['createExtremumBy', 'gt'],
    'memoize': ['MapCache'],
    'merge': ['baseMerge', 'createAssigner'],
    'min': ['createExtremum', 'minBy'],
    'minBy': ['createExtremumBy', 'lt'],
    ...
    'sum': ['baseSum', 'arraySum', 'isArray', 'isIterateeCall', 'getIteratee', 'toIterable'],
    ...
    'uniq': ['baseIteratee', 'baseUniq', 'getIteratee', 'getIndexOf', 'isIterateeCall', 'sortedUniq'],
    ...
    'createDefaults': ['restParam'],
    'createExtremum': [],
    'createExtremumBy': ['arrayExtremum', 'baseExtremum', 'getIteratee', 'isArray', 'isIterateeCall', 'toIterable'],
    'createFind': ['baseFind', 'baseFindIndex', 'getIteratee', 'isArray'],
    'createFindIndex': ['baseFindIndex', 'getIteratee'],
    'createFindKey': ['baseFind', 'getIteratee'],
    'createForEach': ['toFunction', 'isArray'],
    'createForIn': ['toFunction', 'keysIn'],
    'createForOwn': ['toFunction'],
    'createHybridWrapper': ['arrayCopy', 'composeArgs', 'composeArgsRight', 'createCtorWrapper', 'isLaziable', 'reorder', 'replaceHolders', 'setData'],
    'createObjectMapper': ['baseForOwn', 'getIteratee'],
    ...
    'createReduce': ['baseReduce', 'getIteratee', 'isArray'],
    'createRound': [],
    'createSortedIndex': ['baseIteratee', 'binaryIndex', 'binaryIndexBy', 'getIteratee'],
