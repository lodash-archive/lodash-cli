...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'main': ['arrayEach', 'baseForOwn', 'baseMatches', 'baseProperty', 'createHybridWrapper', 'getCallback', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'lodash', 'LodashWrapper', 'mixin', 'thru'],
    ...
    'at': ['baseAt', 'baseFlatten', 'isLength', 'restParam', 'toIterable'],
    ...
    'has': [],
    'identity': [],
    'includes': ['getIndexOf', 'isArray', 'isIterateeCall', 'isLength', 'isString', 'values'],
    ...
    'invoke': ['baseEach', 'isLength', 'restParam'],
    ...
    'propertyOf': [],
    'pull': ['getIndexOf'],
    'pullAt': ['baseAt', 'baseCompareAscending', 'baseFlatten', 'isIndex', 'restParam'],
    ...
    'baseCallback': ['baseMatches', 'baseMatchesProperty', 'baseProperty', 'bindCallback', 'identity'],
    ...
    'baseMatchesProperty': ['baseIsEqual', 'isStrictComparable', 'toObject'],
    ...
    'baseSome': ['baseEach'],
    'baseSortBy': [],
    'baseSortByOrder': ['baseEach', 'baseSortBy', 'compareMultiple', 'isLength'],
    'baseSum': ['baseEach'],
    'baseToString': [],
    ...
    'createBaseEach': ['isLength', 'toObject'],
