...
exports.funcDep = new Hash({
  ...
  'forEach': ['arrayEach', 'baseCastFunction', 'baseEach', 'isArray'],
  'forEachRight': ['arrayEachRight', 'baseCastFunction', 'baseEachRight', 'isArray'],
  'forIn': ['baseCastFunction', 'baseFor', 'keysIn'],
  'forInRight': ['baseCastFunction', 'baseForRight', 'keysIn'],
  'forOwn': ['baseCastFunction', 'baseForOwn'],
  'forOwnRight': ['baseCastFunction', 'baseForOwnRight'],
  'fromPairs': [],
  ...
  'repeat': ['baseRepeat', 'toString', 'toInteger'],
  'replace': ['toString'],
  ...
  'thru': [],
  'times': ['baseCastFunction', 'baseTimes', 'toInteger'],
