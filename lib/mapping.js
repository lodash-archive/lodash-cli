...
module.exports = {
  ...
  'forceInline': createMap({
    ...
    'toInteger': ['charsEndIndex', 'charsStartIndex', 'isString', 'stringToArray', 'toNumber', 'toString', 'trimmedEndIndex', 'trimmedStartIndex'],
  ...
  'funcDep': createMap({
    ...
    'trim': ['toString', 'charsEndIndex', 'charsStartIndex', 'stringToArray', 'trimmedEndIndex', 'trimmedStartIndex'],
    'trimEnd': ['toString', 'charsEndIndex', 'stringToArray', 'trimmedEndIndex'],
    'trimStart': ['toString', 'charsStartIndex', 'stringToArray', 'trimmedStartIndex'],
    ...
    'toFunction': ['identity'],
    'trimmedEndIndex': ['isSpace'],
    'trimmedStartIndex': ['isSpace'],
    'unescapeHtmlChar': []
  }),
