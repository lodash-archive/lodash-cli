...
exports.funcDep = new Hash({
  ...
  'intersection': ['arrayMap', 'baseIntersection', 'rest', 'baseCastArrayLikeObject'],
  'intersectionBy': ['arrayMap', 'baseIntersection', 'getIteratee', 'last', 'rest', 'baseCastArrayLikeObject'],
  'intersectionWith': ['arrayMap', 'baseIntersection', 'last', 'rest', 'baseCastArrayLikeObject'],
  ...
  'now': [],
  'nthArg': ['toInteger'],
  'omit': ['arrayMap', 'baseCastKey', 'baseDifference', 'baseFlatten', 'basePick', 'getAllKeysIn', 'rest'],
  ...
  'repeat': ['baseRepeat', 'isIterateeCall', 'toString', 'toInteger'],
  'replace': ['toString'],
  'rest': ['apply', 'toInteger'],
  'result': ['baseCastPath', 'isFunction', 'isKey'],
  'reverse': [],
  'round': ['createRound'],
  ...
  'split': ['isIterateeCall', 'isRegExp', 'stringToArray', 'toString'],
  'spread': ['apply', 'arrayPush', 'rest', 'toInteger'],
  ...
  'toPath': ['arrayMap', 'baseCastKey', 'copyArray', 'isArray', 'isSymbol', 'stringToPath'],
  ...
  'update': ['baseCastFunction', 'baseUpdate'],
  'updateWith': ['baseCastFunction', 'baseUpdate'],
  ...
  'baseAt': ['get'],
  'baseCastArrayLikeObject': ['isArrayLikeObject'],
  'baseCastFunction': ['identity'],
  'baseCastKey': ['isSymbol'],
  'baseCastPath': ['isArray', 'stringToPath'],
  'baseClamp': [],
  ...
  'baseInvoke': ['apply', 'baseCastPath', 'isKey', 'last', 'parent'],
  ...
  'basePullAt': ['baseCastPath', 'isIndex', 'isKey', 'last', 'parent'],
  'baseRandom': [],
  'baseRange': [],
  'baseReduce': [],
  'baseRepeat': [],
  'baseSet': ['assignValue', 'baseCastPath', 'isIndex', 'isKey', 'isObject'],
  ...
  'baseUnset': ['baseCastPath', 'has', 'isKey', 'last', 'parent'],
  ...
  'createPadding': ['baseRepeat', 'stringSize', 'stringToArray'],
  ...
  'getTag': ['toSource'],
  'getView': [],
  'hasPath': ['baseCastPath', 'isArguments', 'isArray', 'isIndex', 'isKey', 'isLength', 'isString'],
  'indexOfNaN': [],
  'initCloneArray': [],
