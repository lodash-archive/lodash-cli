...
exports.funcDep = new Hash({
  ...
  'now': [],
  'nthArg': ['toInteger'],
  'omit': ['arrayMap', 'arrayPush', 'baseCastKey', 'baseDifference', 'baseFlatten', 'getSymbolsIn', 'isArray', 'keysIn', 'basePick', 'rest'],
  ...
  'toPath': ['arrayMap', 'baseCastKey', 'isArray', 'stringToPath'],
  ...
  'basePickBy': ['arrayPush', 'getSymbolsIn', 'isArray', 'keysIn'],
  'baseProperty': [],
