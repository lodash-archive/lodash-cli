...
module.exports = {
  ...
  'funcDep': createMap({
    ...
    'baseAt': ['get'],
    'baseClone': ['copyArray', 'arrayEach', 'baseAssign', 'baseForOwn', 'initCloneArray', 'initCloneByTag', 'initCloneObject', 'isArray', 'isHostObject', 'isMap', 'isObject', 'isSet', 'Stack'],
    'baseCreate': ['isObject'],
    'baseDelay': [],
    ...
    'baseIsEqualDeep': ['equalArrays', 'equalByTag', 'equalObjects', 'isArray', 'isHostObject', 'isMap', 'isSet', 'isTypedArray', 'Stack'],
    'baseIsFunction': [],
  ...
  'varDep': createMap({
    ...
    // Dependencies of hash functions.
    'Hash': ['nativeCreate'],
    'hashGet': ['HASH_UNDEFINED', 'nativeCreate'],
    'hashHas': ['nativeCreate'],
    'hashSet': ['HASH_UNDEFINED', 'nativeCreate'],
    ...
    // Dependencies of `SetCache` functions.
    'cacheIndexOf': ['HASH_UNDEFINED'],
    'cachePush': ['HASH_UNDEFINED'],
