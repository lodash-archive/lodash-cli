...
exports.forceInline = new Hash({
  'baseClone': ['keys', 'MapCache', 'root', 'Stack'],
  'baseEach': ['baseFor', 'keys'],
  'baseEachRight': ['baseForRight', 'keys'],
  'baseIteratee': ['keys', 'MapCache', 'root', 'Stack'],
  'createSet': ['root'],
  'createWrapper': ['root'],
  'keysIn': ['root'],
  'MapCache': ['root'],
  'SetCache': ['MapCache', 'root'],
  'Stack': ['MapCache', 'root'],
  'stringToPath': ['MapCache', 'memoize', 'root', 'toString'],
...
exports.funcDep = new Hash({
  ...
  'before': ['toInteger'],
  'bind': ['createWrapper', 'getPlaceholder', 'rest', 'replaceHolders'],
  'bindAll': ['arrayEach', 'baseFlatten', 'bind', 'rest'],
  'bindKey': [ 'createWrapper', 'getPlaceholder', 'rest', 'replaceHolders'],
  ...
  'cloneWith': ['baseClone'],
  'compact': [],
  'concat': ['arrayConcat', 'baseFlatten', 'castArray', 'copyArray'],
  ...
  'endsWith': ['baseClamp', 'toInteger', 'toString'],
  'eq': [],
  ...
  'parseInt': ['toString'],
  'partial': ['createWrapper', 'getPlaceholder', 'rest', 'replaceHolders'],
  'partialRight': ['createWrapper', 'getPlaceholder', 'rest', 'replaceHolders'],
  ...
  'result': ['castPath', 'isFunction', 'isKey'],
  'reverse': [],
  'round': ['createRound'],
  ...
  'split': ['castSlice', 'isIterateeCall', 'isRegExp', 'stringToArray', 'toString'],
  'spread': ['apply', 'arrayPush', 'castSlice', 'rest', 'toInteger'],
  'startCase': ['createCompounder', 'upperFirst'],
  'startsWith': ['baseClamp', 'toInteger', 'toString'],
  ...
  'trim': ['castSlice', 'charsEndIndex', 'charsStartIndex', 'stringToArray', 'toString'],
  'trimEnd': ['castSlice', 'charsEndIndex', 'stringToArray', 'toString'],
  'trimStart': ['castSlice', 'charsStartIndex', 'stringToArray', 'toString'],
  'truncate': ['castSlice', 'isObject', 'isRegExp', 'stringSize', 'stringToArray', 'toInteger', 'toString'],
  'unary': ['ary'],
  ...
  'baseInvoke': ['apply', 'castPath', 'isKey', 'last', 'parent'],
  ...
  'baseMatchesProperty': ['baseIsEqual', 'hasIn', 'get', 'isKey', 'isStrictComparable', 'matchesStrictComparable'],
  'baseMean': ['baseSum'],
  ...
  'basePullAt': ['castPath', 'isIndex', 'isKey', 'last', 'parent'],
  'baseRandom': [],
  'baseRange': [],
  'baseReduce': [],
  'baseRepeat': [],
  'baseSet': ['assignValue', 'castPath', 'isIndex', 'isKey', 'isObject'],
  ...
  'baseUnset': ['castPath', 'has', 'isKey', 'last', 'parent'],
  ...
  'createCurryWrapper': ['apply', 'createCtorWrapper', 'createHybridWrapper', 'createRecurryWrapper', 'getPlaceholder', 'replaceHolders'],
  'createFlow': ['baseFlatten', 'getData', 'getFuncName', 'isArray', 'isLaziable', 'LodashWrapper', 'rest'],
  'createHybridWrapper': ['composeArgs', 'composeArgsRight', 'countHolders', 'createCtorWrapper', 'createRecurryWrapper', 'getPlaceholder', 'reorder', 'replaceHolders'],
  'createInverter': ['baseInverter'],
  'createMathOperation': ['isSymbol'],
  'createOver': ['apply', 'arrayMap', 'baseFlatten', 'baseUnary', 'getIteratee', 'isArray', 'isFlattenableIteratee', 'rest'],
  'createPadding': ['baseRepeat', 'castSlice', 'stringSize', 'stringToArray'],
  ...
  'getNative': ['isNative'],
  'getPlaceholder': ['lodash'],
  'getPrototype': [],
  'getSymbols': [],
  'getSymbolsIn': ['arrayPush', 'getPrototype', 'getSymbols'],
  'getTag': ['toSource'],
  'getView': [],
  'hasPath': ['castPath', 'isArguments', 'isArray', 'isIndex', 'isKey', 'isLength', 'isString'],
  'indexOfNaN': [],
  'initCloneArray': [],
  ...
  'isFlattenable': ['isArguments', 'isArray', 'isArrayLikeObject'],
