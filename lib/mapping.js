...
module.exports = {
  ...
  'chainDep': createMap({
    'funcDep': ['arrayEach', 'arrayPush', 'baseForOwn', 'chain', 'createHybridWrapper', 'getIteratee', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'LodashWrapper', 'mixin', 'tap', 'thru', 'toInteger', 'wrapperChain', 'wrapperCommit', 'wrapperConcat', 'wrapperPlant', 'wrapperNext', 'wrapperReverse', 'wrapperToIterator', 'wrapperToString', 'wrapperValue'],
    'objDep': ['realNames']
  }),
