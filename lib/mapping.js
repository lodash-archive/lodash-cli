...
exports.funcDep = new Hash({
  ...
  'constant': [],
  'countBy': ['assignValue', 'createAggregator'],
  ...
  'get': ['baseGet'],
  'groupBy': ['assignValue', 'createAggregator'],
  ...
  'keyBy': ['assignValue', 'createAggregator'],
...
exports.varDep = new Hash({
  ...
  'setTimeout': ['root'],
  'setToString': ['nativeDefineProperty']
});
