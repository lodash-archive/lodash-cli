...
module.exports = {
  ...
  'forceInline': createMap({
    ...
    'getNative': ['baseToString', 'isFunction', 'isNative'],
    'isArray': ['baseToString', 'getNative', 'isFunction', 'isNative'],
    'keys': ['keysIn'],
  ...
  'funcDep': createMap({
    ...
    'main': ['arrayEach', 'arrayPush', 'baseForOwn', 'baseMatches', 'createHybridWrapper', 'getCallback', 'identity', 'isArray', 'last', 'lazyClone', 'lazyReverse', 'lazyValue', 'LazyWrapper', 'lodash', 'LodashWrapper', 'mixin', 'property', 'thru'],
    ...
    'escapeRegExp': ['baseToString', 'escapeStringChar'],
    ...
    'isNaN': ['isNumber'],
    'isNative': ['escapeRegExp', 'isFunction', 'isHostObject', 'isObjectLike'],
    'isNull': [],
    ...
    'createExtremum': ['arrayExtremum', 'baseExtremum', 'getCallback', 'isArray', 'isIterateeCall', 'toIterable'],
