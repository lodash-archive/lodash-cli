...
exports.funcDep = new Hash({
  ...
  'sample': ['arraySample', 'isArrayLike', 'values'],
  'sampleSize': ['arraySampleSize', 'isArrayLike', 'isIterateeCall', 'toInteger', 'values'],
  'set': ['baseSet'],
  'setWith': ['baseSet'],
  'shuffle': ['copyArray', 'isArrayLike', 'shuffleSelf', 'values'],
  ...
  'arraySampleSize': ['arrayShuffle', 'baseClamp'],
