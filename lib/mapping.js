...
exports.funcDep = new Hash({
  ...
  'isEmpty': ['baseKeys', 'getTag', 'isArguments', 'isArray', 'isArrayLike', 'isBuffer', 'isFunction', 'isObjectLike', 'isPrototype', 'isString'],
  'isEqual': ['baseIsEqual'],
  ...
  'keys': ['baseKeys', 'indexKeys', 'isArrayLike', 'isIndex', 'isPrototype'],
