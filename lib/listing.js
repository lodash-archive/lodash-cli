...
_.assign(module.exports, {
  ...
  'coreFuncs': [
    'bind', 'chain', 'clone', 'defaults', 'defer', 'delay', 'escape',
    'extend', 'filter', 'find', 'first', 'flatten', 'forEach', 'has',
    'indexOf', 'invoke', 'isArray', 'isEmpty', 'isEqual', 'isFunction',
    'isRegExp', 'isString', 'iteratee', 'keys', 'last', 'map', 'mixin',
    'once', 'pick', 'result', 'size', 'some', 'sortBy', 'uniqueId',
    'value', 'values'
  ],
